...
public class Constants {
    ...
    public static final int TOTAL_BLOCK_OFFSET = DATABASE_SIZE_OFFSET + DATABASE_SIZE_SIZE; // 位图大小偏移量
    public static final int TOTAL_BLOCK_SIZE = 8; // 位图大小

    public static final int TOTAL_PFS_FILES_OFFSET = TOTAL_BLOCK_OFFSET + TOTAL_BLOCK_SIZE; // 总PFS文件数偏移量
